...
np.savetxt('HMM_parameters/baseline/dry_state_means.txt',dry_means)
np.savetxt('HMM_parameters/baseline/wet_state_means.txt',wet_means)
np.savetxt('HMM_parameters/baseline/covariance_matrix_dry.txt',covariance_dry)
np.savetxt('HMM_parameters/baseline/covariance_matrix_wet.txt',covariance_wet)
np.savetxt('HMM_parameters/baseline/transition_matrix.txt', transition_matrix)
np.savetxt('HMM_parameters/baseline/hist_hidden_states.txt', hidden_states)
