...
import os
os.chdir('paper_code/SyntheticRecordGeneration/')
#%%
def generate_synthetic_records(ensemble_type, num_syn_records, scaling):
    """
    ...
    :param scaling:                     float, scaling factor for mean log flows
    """

    # load the baseline HMM parameters
    ...
    # modify the dry and wet state means
    dry_state_means = dry_state_means*scaling
    wet_state_means = wet_state_means*scaling
...
generate_synthetic_records("ClimateAdjusted_zero_zero_five", 1000,.995)
print('Done')
